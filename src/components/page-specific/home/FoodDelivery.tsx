    ...
    <section className="food-delivery padding-left-and-right padding-top-80 padding-bottom-80 display-grid">
      ...
      <div className="button-wrapper">
        <Button
          ...
          buttonSize="large"
          additionalClassNames={`full-flex gap-10 justify-content-space-evenly ${firstButtonInView ? " fade-in-button" : ""}`}
          children={
            <svg
              role="img"
              viewBox="0 0 24 24"
        ...
        <Button
          ...
          url="/order"
          buttonSize="large"
          additionalClassNames={`full-flex gap-10 justify-content-space-evenly ${secondButtonInView ? " fade-in-button" : ""}`}
          children={
            <svg
              role="img"
              viewBox="0 0 24 24"
        ...
        <Button
          ...
          url="/order"
          buttonSize="large"
          additionalClassNames={`full-flex gap-10 justify-content-space-evenly ${thirdButtonInView ? " fade-in-button" : ""}`}
          children={
            <svg
              role="img"
              viewBox="0 0 24 24"
